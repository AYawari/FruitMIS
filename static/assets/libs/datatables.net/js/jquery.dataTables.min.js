...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"اولی",sLast:"آخری",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"هیچ ریکاردی فعلا موجود نمی باشد.",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ ریکارد",sInfoEmpty:"نمایش 0 تا 0 از 0 ریکارد",sInfoFiltered:"(filtered from _MAX_ total entries)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ ریکارد",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,
